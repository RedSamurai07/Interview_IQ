...
@tool
def detect_filler_words(text: str) -> str:
    ...
    fillers = ['um', 'uh', 'like', 'you know', 'basically', 'actually', 'literally'
                    ...
                    'I mean', 'I guess', 'I suppose', 'I think', 'I feel', 'I believe'
                    'I mean', 'I guess', 'I suppose', 'I think', 'I feel', 'I believe'
                    'I mean', 'I guess', 'I suppose', 'I think', 'I']
    words = re.findall('r\b+w\b', text.lower())
    found_fillers = {filler: text.count(filler) for filler in fillers if text.count(filler) > 0}
...
@tool
def detect_repetitive_phrases(text: str) -> str:
...
@tool
def detect_long_sentences(text: str) -> str:
...
@tool
def detect_long_pauses(text: str) -> str:
...
# checks of answers in star structure format
@tool
...
def score_relevance(text: str, expected_keywords: list) -> dict:
    """Scores the releveance of the candidate's answer based on the presence of the expected keywords."""
